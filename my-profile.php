...
include('conn.php');
$aid=$_SESSION['id'];
$sql="SELECT * FROM register WHERE r_id =$aid;";
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-9 col-md-push-3">
					...
					<form name="agent-from"  enctype="multipart/form-data">
					<div class="row margin-top-60">
						...
						<div class="col-xs-12 col-sm-9 col-md-8" >
							<div class="labelled-input">
								<label for="first-name">First name</label><input id="first-name" disabled="disabled"  name="first-name" type="text" class="input-full main-input" placeholder="" value="<?php echo $row['r_fname']; ?>"/>
								<div class="clearfix"></div>
							</div>
							<div class="labelled-input">
								<label for="last-name">Last name</label><input id="last-name" disabled="disabled" name="last-name" type="text" class="input-full main-input" placeholder="" value="<?php echo $row['r_lname']; ?>"/>
								<div class="clearfix"></div>
							</div>
							<div class="labelled-input">
								<label for="email">Email</label><input id="email" disabled="disabled"  name="email" type="email" class="input-full main-input" placeholder="" value="<?php echo $row['r_email']; ?>"/>
								<div class="clearfix"></div>
							</div>
							<div class="labelled-input">
					...
					<div class="row margin-top-15">
						<div class="col-xs-12">
							<div class="center-button-cont center-button-cont-border">
								<a href="edit.php?id=<?php echo $row['r_id']; ?>" class="button-primary button-shadow">
									<span>edit</span>
				...
				<div class="col-xs-12 col-md-3 col-md-pull-9">
					<div class="sidebar-left">
						...
						<div class="center-button-cont margin-top-15">
							<a href="edit.php" class="button-alternative button-shadow button-full">
