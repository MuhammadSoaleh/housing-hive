...
<!-- Mirrored from apartment-html.chart.civ.pl/agents-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 08:10:25 GMT -->
<head>
	<meta charset="utf-8">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-lg-12 short-image-title">
					<h5 class="subtitle-margin second-color">meet</h5>
					<h1 class="second-color">our team</h1>
				...
				<div class="col-xs-12 col-md-9">		
						<div class="row">
							<div class="col-xs-4 col-sm-4">
								<img src="images/page-photo.jpg" class="img-responsive" alt="" />
							</div>
						...
						<div class="row team-member-row">
							<div class="col-xs-12 col-sm-6 col-lg-4 team-member-col">
...
<!-- Mirrored from apartment-html.chart.civ.pl/agents-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 08:10:33 GMT -->
</html>