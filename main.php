...
<!-- Mirrored from apartment-html.chart.civ.pl/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 08:03:17 GMT -->
<head>
	<meta charset="utf-8">
				...
				<div class="row">
					<div class="col-xs-5 col-sm-8">
						<div class="top-mail pull-left hidden-xs">
							...
							<span class="top-bar-text">Housingive@gmail.com</span>
						</div>
						<div class="top-phone pull-left hidden-xxs">
							<span class="top-icon-circle">
								<i class="fa fa-phone"></i>
							</span>
							<span class="top-bar-text">03009271554</span>
						</div>
					...
					<div class="col-xs-7 col-sm-4">
						<div class="top-social-last top-dark pull-right" data-toggle="tooltip" data-placement="bottom" title="Login/Register">
							<a class="top-icon-circle" href="login.php" >
		...
		<nav class="navbar main-menu-cont">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="main.php" title="" class="navbar-brand">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li class="">
							<a href="main.php" class="nav-link" role="button">Home</a>
							
						</li>
						<li class="navbar">
							<a href="listing.php" class="nav-link" >Listings</a>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li class="dropdown">
									<a tabindex="-1" href="agencies-listing.php">Agencies Listing</a>
									
								</li>
								<li class="dropdown">
									<a tabindex="-1" href="agency-details.php">Agency Details</a>
									
								</li>
								<li class="dropdown">
									<a tabindex="-1" href="agents.php">Agents List</a>
						...
						<li class="navbar">
							<a href="my-profile.php" class="nav-link" >Profile</a>
							
						</li>
						<li class="dropdown">
							<a href="blogs.php" class="nav-link"  role="button" aria-haspopup="true" aria-expanded="false">Blog</a>
				...
				<div class="row">
					<div class="col-xs-12 owl-carousel" id="testimonials-owl">
						<div class="testimonial2">
							<img src="images/testimonials1b.jpg" alt="" class="testimonials-photo img-circle" />	
						...
						<div class="testimonial2">
							<img src="images/testimonials2b.jpg" alt="" class="testimonials-photo img-circle" />	
							<div class="testimonials2-content">
						...
						<div class="testimonial2">
							<img src="images/testimonials3b.jpg" alt="" class="testimonials-photo img-circle" />
							<div class="testimonials2-content">
				...
				<div class="col-xs-12">
					<div class="masonry-grid">
						...
						<article class="masonry-grid-item masonry-grid-item-big big-blog-grid2-item zoom-cont">
							<figure><a href="blog-right-sidebar.html"><img src="images/big-blog-grid2.jpg" alt="" class="zoom" /></a></figure>
						...
						<article class="masonry-grid-item blog-grid2-item zoom-cont">
							<figure><a href="blog-right-sidebar.html"><img src="images/blog-grid2a.jpg" alt="" class="zoom" /></a></figure>
							<div class="blog-grid2-post-content">											
						...
						<article class="masonry-grid-item blog-grid2-item zoom-cont">
							<figure><a href="blog-right-sidebar.html"><img src="images/blog-grid2b.jpg" alt="" class="zoom" /></a></figure>
							<div class="blog-grid2-post-content">											
						...
						<article class="masonry-grid-item blog-grid2-item zoom-cont">
							<figure><a href="blog-right-sidebar.html"><img src="images/blog-grid2c.jpg" alt="" class="zoom" /></a></figure>
							<div class="blog-grid2-post-content">								
						...
						<article class="masonry-grid-item blog-grid2-item zoom-cont">
							<figure><a href="blog-right-sidebar.html"><img src="images/blog-grid2d.jpg" alt="" class="zoom" /></a></figure>
							<div class="blog-grid2-post-content">				
						...
						<article class="masonry-grid-item blog-grid2-item zoom-cont">
							<figure><a href="blog-right-sidebar.html"><img src="images/blog-grid2e.jpg" alt="" class="zoom" /></a></figure>
							<div class="blog-grid2-post-content">									
						...
						<article class="masonry-grid-item blog-grid2-item zoom-cont">
							<figure><a href="blog-right-sidebar.html"><img src="images/blog-grid2f.jpg" alt="" class="zoom" /></a></figure>
							<div class="blog-grid2-post-content">							
...
<!-- Login modal -->
	<div class="modal fade apartment-modal" id="login-modal" method="post">
...
<!-- Register modal -->
	<form class="modal fade apartment-modal" id="register-modal" method="post">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<a href='my-profile.php'  class="button-primary button-shadow button-full" name="sub">
						<span>Sign up</span>
						<div class="button-triangle"></div>
						<div class="button-triangle2"></div>
						<div class="button-icon"><i class="fa fa-user"></i></div>
...
<!-- Mirrored from apartment-html.chart.civ.pl/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 08:03:34 GMT -->
</html>