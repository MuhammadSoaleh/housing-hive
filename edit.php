...
$sql="SELECT * FROM `register` WHERE r_id = $id";
...
if(isset($_POST['up'])){
    ...
    $email=$_POST['email'];
    $sql1="UPDATE `register` SET `r_fname`='$fname',`r_lname`='$lname', `r_email`='$email' WHERE r_id = $id";
					...
					<div class="row margin-top-60">
						<div class="col-xs-6 col-xs-offset-3 col-sm-offset-0 col-sm-3 col-md-4">	
							<div class="agent-photos">
								<img src="" id="agent-profile-photo" class="img-responsive" alt="" />
								<div class="change-photo">
									<i class="fa fa-pencil fa-lg"></i>
									<input type="file" name="agent-photo" id="agent-photo" />
								</div>
								<input type="text" id="agent-file-name" class="main-input" />
							</div>
						</div>
						<div class="col-xs-12 col-sm-9 col-md-8">
							<div class="labelled-input">
								<label for="first-name">First name</label><input id="first-name" name="first-name" type="text" class="input-full main-input" placeholder="" value="<?php echo $row['r_fname'];?>"/>
								<div class="clearfix"></div>
							</div>
							<div class="labelled-input">
								<label for="last-name">Last name</label><input id="last-name" name="last-name" type="text" class="input-full main-input" placeholder="" value="<?php echo $row['r_lname'];?>"/>
								<div class="clearfix"></div>
							</div>
							<div class="labelled-input">
								<label for="email">Email</label><input id="email" name="email" type="email" class="input-full main-input" placeholder="" value="<?php echo $row['r_email'];?>"/>
								<div class="clearfix"></div>
							</div>
							<div class="labelled-input">
					...
					<div class="row margin-top-15">
						<div class="col-xs-12">
							<div class="center-button-cont center-button-cont-border">
								<button style="border:none;" name="up" class="button-primary button-shadow">
									<span>save</span>
					...
					<div class="sidebar-left">
						...
						<div class="profile-info margin-top-60">
							...
							<div class="profile-info-text pull-left">
								...
								<a href="logout.php" class="logout-link margin-top-30"><i class="fa fa-lg fa-sign-out"></i>Logout</a>
							</div>
							<div class="clearfix"></div>
						</div>
